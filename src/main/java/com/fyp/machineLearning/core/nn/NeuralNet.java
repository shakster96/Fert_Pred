package com.fyp.machineLearning.core.nn;

import java.util.ArrayList;
import java.util.List;

import com.fyp.machineLearning.core.function.activation.ActivationFunction;
import com.fyp.machineLearning.core.function.activation.IdentityActivationFunction;
import com.fyp.machineLearning.core.function.activation.SigmoidActivationFunction;
...
public class NeuralNet {
	...
	public static void main(String[] args) {
		NeuralNet neuralNet = new NeuralNet(2, 4,
				1, new SigmoidActivationFunction());
		int maxRuns = 50000;
